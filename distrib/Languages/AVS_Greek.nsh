...
LangString AVS_Standalone           ${AvsLang} "Αυτόνομη, Unpack Files only" ; To be translated
...
LangString Czech_Text               ${AvsLang} "Τσέχικη τεκμηρίωση"
...
LangString Japanese_Text            ${AvsLang} "Ιαπωνική Τεκμηρίωση"
LangString Polish_Text              ${AvsLang} "Πολωνική Τεκμηρίωση"
...
LangString StandAlone_Bubble        ${AvsLang} "Εγκατάσταση των κύριων αρχείων στο φάκελο του Προϊόντος \
                                                (μη λειτουργική εγκατάσταση εάν δεν είστε Διαχειριστής) \
                                                (Πρέπει να επιλέξετε Αυτόνομη εγκατάσταση)"
LangString Documentation_Bubble     ${AvsLang} "Εγκατάσταση βοήθειας. Παρακαλώ επιλέξτε γλώσσες \
                                                (οι μη-Αγγλικές ενδέχεται να μην είναι πλήρως ενημερωμένες)"
LangString English_Bubble           ${AvsLang} "Εγκατάσταση Αγγλικής βοήθειας"
LangString Czech_Bubble             ${AvsLang} "Εγκατάσταση Τσέχικης βοήθειας"
...
LangString Japanese_Bubble          ${AvsLang} "Εγκατάσταση Ιαπωνικής βοήθειας"
LangString Polish_Bubble            ${AvsLang} "Εγκατάσταση Πολωνικής βοήθειας"
...
LangString Associate1_Bubble        ${AvsLang} "’νοιγμα αρχείων AVS απευθείας με το Notepad για επεξεργασία"
...
LangString Start_License            ${AvsLang} "’δεια χρήσης"
...
LangString Start_Doc_Czech          ${AvsLang} "Τσέχικη τεκμηρίωση AviSynth"
