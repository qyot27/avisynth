;----------------------------------
; By Malow -- http://forum.doom9.org/member.php?u=19920
;----------------------------------
;
...
LangString Polish_Text              ${AvsLang} "Documentação em Polonês"
...
LangString Czech_Bubble             ${AvsLang} "Instala Ajuda em Tcheco"
...
LangString Polish_Bubble            ${AvsLang} "Instala Ajuda em Polonês"
...
LangString Associate2_Bubble        ${AvsLang} "Reproduzir arquivos AVS diretamente no Media Player 6.4 (clique direito - Reproduzir)"
LangString Associate3_Bubble        ${AvsLang} "Cria um novo Script do AviSynth em branco (clique direito - Novo - AviSynth Script)"
...
LangString Start_Doc_Czech          ${AvsLang} "Documentação em Tcheco"
...
!define AvsLicenceFile "gpl-pt_br.txt"
