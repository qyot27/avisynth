;----------------------------------
; By talen9 -- http://forum.doom9.org/member.php?u=133924
;----------------------------------
;
...
LangString AVS_Standalone           ${AvsLang} "Autonoma, Unpack Files only" ; To be translated
...
LangString Polish_Text              ${AvsLang} "Documentazione in Polacco"
...
LangString Polish_Bubble            ${AvsLang} "Installa la documentazione in Polacco"
