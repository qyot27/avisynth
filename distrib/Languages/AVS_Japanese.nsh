...
;----------------------------------
;
; Japanese -- Code page 1041
;
;----------------------------------
LangString AVS_Standard             ${AvsLang} "標準"
LangString AVS_Minimal              ${AvsLang} "最小"
LangString AVS_Standalone           ${AvsLang} "スタンドアローン（ファイル展開のみ）"
...
LangString StandAlone_Text          ${AvsLang} "製品ディレクトリにインストール"
...
LangString Polish_Text              ${AvsLang} "ポーランド語"
...
LangString SystemInstall_Bubble     ${AvsLang} "主要なファイルをシステムディレクトリにインストールします（通常）"
LangString StandAlone_Bubble        ${AvsLang} "すべてのファイルを製品ディレクトリに展開します\
                                                （機能しない、非管理者向けの展開）\
                                                （インストールタイプ「スタンドアローン（ファイル展開のみ）」を選択する必要あり）"
LangString Documentation_Bubble     ${AvsLang} "ヘルプをインストールします。言語を選択してください\
                                                （英語以外は内容が古いかもしれません）"
...
LangString Polish_Bubble            ${AvsLang} "ポーランド語のヘルプをインストールします。"
...
LangString Start_Doc_Czech          ${AvsLang} "AviSynth ヘルプ（チェコ語）"
